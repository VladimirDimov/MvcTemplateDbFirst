...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TopDestinationsSearchResult :  IEquatable<TopDestinationsSearchResult>
    {
        /// <summary>
        ...
        public TopDestinationsSearchResult(string Destination = null, int? Flights = null, int? Travelers = null)
        {
            ...
            if (Flights == null)
            {
                throw new InvalidDataException("Flights is a required property for TopDestinationsSearchResult and cannot be null");
            }
            else
            {

...
-- --------------------------------------------------
-- Date Created: 10/11/2016 15:11:21
-- Generated from EDMX file: C:\Users\User3\Desktop\Projects\Tourism POC\TourPoc\Source\Data\TourPoc.Data\TourPocDb.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[C__MigrationHistory1111]', 'U') IS NOT NULL
    DROP TABLE [dbo].[C__MigrationHistory1111];
GO
...
-- Creating table 'C__MigrationHistory1111'
CREATE TABLE [dbo].[C__MigrationHistory1111] (
...
-- Creating primary key on [MigrationId], [ContextKey] in table 'C__MigrationHistory1111'
ALTER TABLE [dbo].[C__MigrationHistory1111]
ADD CONSTRAINT [PK_C__MigrationHistory1111]
